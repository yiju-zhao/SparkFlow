...
PROMPT_OPTIMIZER_SYSTEM = """# Role: User Prompt General Optimization Expert
...
PROMPT_OPTIMIZER_USER_TEMPLATE = """Please optimize the following user prompt to eliminate ambiguity and supplement key information.
...
User prompt to optimize:{question}
