 [Skip to content](https://opendatalab.github.io/MinerU/reference/output_files/#mineru-output-files-documentation)
...
![layout page example](https://opendatalab.github.io/MinerU/images/layout_example.png)
...
![span page example](https://opendatalab.github.io/MinerU/images/spans_example.png)
...
##### Page Information Structure (pdf\_info)
...
#### Content List (content\_list.json)
...
### Common Content List V2 (content\_list\_v2.json)(development version, subject to change)
